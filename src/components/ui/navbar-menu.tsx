...
export const Menu = ({
  ...
  return (
    <nav
      ...
      className="relative rounded-full border border-transparent dark:bg-black dark:border-white/[0.2] bg-purple shadow-input flex justify-center space-x-4 px-8 py-6 "
    >
      {children}
    </nav>
  );
