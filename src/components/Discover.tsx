...
export const Discover = () => {
  ...
  <svg className="w-auto h-80" width="328" height="401" viewBox="0 0 328 401" fill="none" xmlns="http://www.w3.org/2000/svg">
    <rect x="131" y="56" width="60" height="315" fill="url(#paint0_linear_50_493)"/>
    <g clip-path="url(#clip0_50_493)">
      <rect x="131" y="341" width="60" height="60" rx="10" fill="#9900e0"/>
      <rect x="174.5" y="333.5" width="24" height="24" rx="4.5" fill="#9d00ff" stroke="#a754e3"/>
      <rect x="123.5" y="333.5" width="24" height="24" rx="4.5" fill="#9d00ff" stroke="#a754e3"/>
      <rect x="123.5" y="384.5" width="24" height="24" rx="4.5" fill="#9d00ff" stroke="#a754e3"/>
      <rect x="146.5" y="356.5" width="29" height="29" rx="4.5" fill="#9d00ff" stroke="#a754e3"/>
      ...
      <rect x="174.5" y="384.5" width="24" height="24" rx="4.5" fill="#9d00ff" stroke="#a754e3"/>
    </g>
    ...
    <g clip-path="url(#clip1_50_493)">
      <rect x="250" y="299" width="50" height="50" rx="8" fill="#9900e0"/>
      <rect x="287.5" y="288.5" width="24" height="24" rx="3.5" fill="#9d00ff" stroke="#a754e3"/>
      <rect x="238.5" y="288.5" width="24" height="24" rx="3.5" fill="#9d00ff" stroke="#a754e3"/>
      <rect x="238.5" y="335.5" width="24" height="24" rx="3.5" fill="#9d00ff" stroke="#a754e3"/>
      <rect x="262.5" y="311.5" width="25" height="25" rx="3.5" fill="#9d00ff" stroke="#a754e3"/>
      <rect x="287.5" y="335.5" width="24" height="24" rx="3.5" fill="#9d00ff" stroke="#a754e3"/>
    ...
    <g clip-path="url(#clip2_50_493)">
      <rect x="31" y="295" width="40" height="40" rx="6" fill="#9900e0"/>
      <rect x="60.5" y="282.5" width="24" height="24" rx="2.5" fill="#9d00ff" stroke="#a754e3"/>
      <rect x="17.5" y="282.5" width="24" height="24" rx="2.5" fill="#9d00ff" stroke="#a754e3"/>
      <rect x="17.5" y="323.5" width="24" height="24" rx="2.5" fill="#9d00ff" stroke="#a754e3"/>
      <rect x="41.5" y="305.5" width="19" height="19" rx="2.5" fill="#9d00ff" stroke="#a754e3"/>
      <rect x="60.5" y="323.5" width="24" height="24" rx="2.5" fill="#9d00ff" stroke="#a754e3"/>
