      ...
      <div className="container mx-auto px-4 py-8 max-w-3xl mt-[8rem]">
        <div className="space-y-6">
          <div className="text-center space-y-2">
            <h1 className="text-4xl font-bold tracking-tight text-white">Business Profile Setup</h1>
          ...
          <div className="space-y-4">
            ...
            <div className="flex justify-between px-2">
              <div className="flex flex-col items-center">
                <div className={`rounded-full p-2 ${step >= 1 ? 'bg-blue-600' : 'bg-gray-700'}`}>
                  <Building2 className="h-6 w-6 text-white" />
                </div>
                <span className="text-sm mt-1 text-gray-300">Business</span>
              </div>
              <div className="flex flex-col items-center">
                <div className={`rounded-full p-2 ${step >= 2 ? 'bg-blue-600' : 'bg-gray-700'}`}>
                  <Globe className="h-6 w-6 text-white" />
                </div>
                <span className="text-sm mt-1 text-gray-300">Website</span>
              </div>
              <div className="flex flex-col items-center">
                <div className={`rounded-full p-2 ${step >= 3 ? 'bg-blue-600' : 'bg-gray-700'}`}>
